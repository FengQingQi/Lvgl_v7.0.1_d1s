...
#define __GMP_CC "riscv64-unknown-linux-gnu-gcc"
#define __GMP_CFLAGS "-Os -pipe -mcmodel=medany -mabi=lp64d -march=rv64gcxthead -g3 -fno-caller-saves -Wno-format-truncation -Wno-unused-result  -Wformat -Werror=format-security -Wl,-z,now -Wl,-z,relro -fpic "
