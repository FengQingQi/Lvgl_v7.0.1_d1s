...
# Makefile
#
CC = ../tina-d1-h/prebuilt/gcc/linux-x86/riscv/toolchain-thead-glibc/riscv64-glibc-gcc-thead_20200702/bin/riscv64-unknown-linux-gnu-gcc
LVGL_DIR_NAME ?= lvgl
LVGL_DIR ?= ${shell pwd}
...
TARGETCONFIG_PREFIX = ../f33-a_lvgl_v7.0.1/d1s-nezha/staging_dir/target
